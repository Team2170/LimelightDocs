...
.. image:: img/gif/SeriousLegitimateDowitcher.gif
...
.. image:: img/gif/HandyCompleteHerring.gif
...
.. image:: img/gif/ConfusedQuerulousLiger.gif

Here’s the full screen, showing the tag ambiguity:

.. image:: img/gif/ElementaryCarefulHoopoe.gif
...
* Crop Filtering
	...
	* .. image:: img/gif/ChillyWhimsicalGander.gif
...
* Corners feature now compatible with smart target grouping
	...
	* .. image:: img/gif/DaringTatteredBlowfish.gif
...
* Hue Rainbow
	...
	* .. image:: img/gif/BoldDishonestAntarcticgiantpetrel.gif
...
* Hardware Panning
	...
	* .. image:: img/gif/UntidyElaborateDartfrog.gif
	* Hardware Panning on the  X and Y axes at 3x Hardware Zoom
	* .. image:: img/gif/EdibleTimelyElver.gif 
...
* New SolvePNP / 3D features (Still experimental)
	...
	* .. image:: img/gif/MemorableHastyFiddlercrab.gif
	...
	* .. image:: img/gif/DeadUnevenJackrabbit.gif
...
* Tooltips
	...
	* .. image:: img/gif/SeparateHonestEthiopianwolf.gif
...
* High-Precision Mode and PnP
	...
	* In the following gif, a Limelight 2 was placed 37 inches behind and 14.5 inches to the right of the target.
		* .. image:: img/gif/ThirstyFailingGreatdane.gif
	* The Limelight was later turned by hand. Notice how the distances remain mostly unchanged:
		* .. image:: img/gif/DisloyalUnfinishedAntipodesgreenparakeet.gif
...
* Black Level
	...
	* .. image:: img/gif/FoolishUnimportantLacewing.gif
...
* Direction Filter
	...
	* .. image:: img/gif/HalfUnselfishHarvestmen.gif
		:align: center
...
* Contour Sort Mode
	...
	* .. image:: img/gif/PlaintiveSizzlingEskimodog.gif
...
* Snapshots
	...
	* .. image:: img/gif/ComplexConstantGalapagosalbatross.gif
...
* Thresholding wands
	...
	* .. image:: img/gif/FarHandyCanvasback.gif
	* The "Subtract" wand adjusts HSV parameters to ignore the selected pixel
	* .. image:: img/gif/HoarseEnragedIslandwhistler.gif

* Snapshots
	
	* .. image:: img/gif/WindyDefiantCrayfish.gif
...
* New Vision Pipeline interface:
	...
	* .. image:: img/gif/UnfitLankyHadrosaurus.gif
...
* Target "Grouping" option:
	...
	* .. image:: img/gif/ScalyDeficientBrahmanbull.gif
